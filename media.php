...
<div id="main_container">
	<div class="top_bar">
    	<div class="top_search">
        	<div class="search_text">Cari</div>
       ...
       <div id="menu_tab">
            <div class="left_menu_corner"></div>
              <ul class="menu">
                ...
                <li class="divider"></li>
		            <li><a href="cara-pembelian.html" class="nav3">Cara Pesan</a></li>
                <li class="divider"></li>
		            <li><a href="semua-produk.html" class="nav4">Pesanan Kami</a></li>
                <li class="divider"></li>
		            <li><a href="hubungi-kami.html" class="nav6">Contact us</a></li>        
                <li class="divider"></li>
              </ul>
